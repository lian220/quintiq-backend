...
| # | Job 이름 | 실행 시간 | 역할 | 상태 |
|---|----------|----------|------|------|
| 1 | economicDataUpdateJob | 06:05 (매일) | 경제 데이터 수집 (FRED + Yahoo) | ✅ 완료 |
| 2 | parallelAnalysisJob | 23:05 (매일) | 기술적 지표 + 감정 분석 병렬 실행 | ⚠️ TODO |
| 3 | economicDataUpdate2Job | 23:00 (매일) | 경제 데이터 재수집 + Vertex AI | ✅ 완료 |
| 4 | combinedAnalysisJob | 23:45 (매일) | 통합 분석 (기술 70% + 감정 30%) | ✅ 완료 |
| 5 | autoBuyJob | 23:50 (매일) | 자동 매수 실행 | ✅ 완료 |
...
#### 8. 자동 매도 체크 (AutoSellJobAdapter) - 신규
